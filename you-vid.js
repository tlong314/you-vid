/**
 * @overview A JavaScript module that extends right-click menu options for videos on the web.
...
;var YouVid = (function(elm) {
	 ...
	 * @param {number} advance - The time in the video (in seconds) to advance in each frame change.
	 * @returns {Object} The current YouVid object.
	 */
	 ...
	 * @returns {number} The entered video time in seconds.
	 */
